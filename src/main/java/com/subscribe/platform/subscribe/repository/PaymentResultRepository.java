...
public interface PaymentResultRepository extends JpaRepository<PaymentResult, Long> {
    List<PaymentResult> findByOwnerIdAndCreatedDateBetween(@Param("customerId") Long customerId, @Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);
}
